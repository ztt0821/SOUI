...
parser.add_argument('--datadir_syn', default='/home/ted/ztt/dataset/denoise', help='path to syn training images')
parser.add_argument('--Real20Path', default='/home/ted/ztt/dataset/denoise', help='path to real training images')
...
parser.add_argument('--outf', default='checkpoints2new/', help='folder to output images and model checkpoints')
parser.add_argument('--test_model', default='checkpoints2new/88_PL_netG.pth', help='path to model for test.')
