...
class CTDataset(Dataset):
    ...
    def __init__(self, root_dir, img_size=128, is_train=True):
        ...
        if is_train:
            ...
            self.dir_noise = glob.glob(os.path.join(self.root_dir, 'self_ul_new_bright_small', '*.png'))
        else:
            self.dirs = glob.glob(os.path.join(self.root_dir, 'test_small', '*.png'))
            self.dir_noise = glob.glob(os.path.join(self.root_dir, 'self_ul_new_test_bright_small', '*.png'))
        self.lennoise = len(self.dirs)
